// // Assuming the full JSON is stored in a variable named `jsonData`
// // (paste the entire object into your environment or load it via require/import)
...
//           });
//         } else {
//           // If no subtopics, still include the topic with blank subtopic
//           rows.push({
//             Category: categoryName,
//             Chapter: chapterName,
//             Topic: topicName,
...
// // Counters for overall totals
// let totalCategories = data.categories.length;
// let totalChapters = 0;
// let totalTopics = 0;
// let totalSubtopics = 0;

// // Arrays for summary tables
...
//   // Per-category: number of chapters
//   categorySummary.push({ Category: catName, Chapters: numChapters });
...
//     // Per-chapter: number of topics (with category context)
//     chapterSummary.push({ Category: catName, Chapter: chName, Topics: numTopics });

//     topics.forEach(t => {
//       const tName = t.name;
//       const subtopics = t.subtopics || [];
//       const numSubtopics = subtopics.length;
//       totalSubtopics += numSubtopics;

//       // Per-topic: number of subtopics (with full hierarchy)
//       topicSummary.push({
//         Category: catName,
//         Chapter: chName,
//         Topic: tName,
//         Subtopics: numSubtopics
//       });
//     });
//   });
// });
...
// console.log('\n=== Category Summary (Chapters per Category) ===');
// console.table(categorySummary);

// console.log('\n=== Chapter Summary (Topics per Chapter) ===');
// console.table(chapterSummary);

// console.log('\n=== Topic Summary (Subtopics per Topic) ===');
...
//     rows.push({ Category: catName, Chapter: chName, 'Topics per Chapter': topicCount });
//   });
// });
...
//   const chapters = cat.chapters || [];
//   const numChapters = chapters.length;
//   // Sum topics across all chapters in this category
//   let totalTopics = 0;
//   chapters.forEach(ch => {
...
//   });
//   grandChapters += numChapters;
//   grandTopics += totalTopics;
// });

// // Display as a table
// console.table(categoryStats);

// // And show the total row (since console.table doesn't add a total row)
// console.log('----------------------------------------');
// console.log(`Total         ${grandChapters}         ${grandTopics}`);

// let totalTopicss = 0, totalSubtopicsa = 0;
// data.categories.forEach(cat => {
//   cat.chapters.forEach(ch => {
//     ch.topics.forEach(t => {
//       totalTopicss++;
//       totalSubtopicsa += (t.subtopics || []).length;
//     });
//   });
// });
// console.log('Total topics:', totalTopicss);
// console.log('Total subtopics:', totalSubtopicsa);
